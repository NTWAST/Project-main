...
//   lv_chart_set_type(objects.chartadc, LV_CHART_TYPE_LINE);
//   // Set the number of points on the chart
//   lv_chart_set_point_count(objects.chartadc, pointcount);
//   // Set the range of the Y axis
//   lv_chart_set_range(objects.chartadc, LV_CHART_AXIS_PRIMARY_Y, min_value, max_value);
//   // Create a data series for the chart
//   data1 = lv_chart_add_series(objects.chartadc, lv_color_hex(0xffff696a), LV_CHART_AXIS_PRIMARY_Y);
